...
const _isUndefined = types.isUndefined;
const _isEmptyObject = types.isEmptyObject;

const _isAbsoluteIri = url.isAbsolute;

const _asArray = util.asArray;
const _addValue = util.addValue;
const _getValues = util.getValues;
const _validateTypeValue = util.validateTypeValue;

const _expandIri = context.expandIri;
const _getContextValue = context.getContextValue;
const _isKeyword = context.isKeyword;
const _processContext = context.process;
const _processingMode = context.processingMode;

const _isList = graphTypes.isList;
const _isValue = graphTypes.isValue;
const _isGraph = graphTypes.isGraph;
const _isSubject = graphTypes.isSubject;
